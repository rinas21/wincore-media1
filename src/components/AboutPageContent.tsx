  ...
  return (
    <div ref={containerRef} className="bg-background min-h-screen text-foreground">
      ...
      <section className="relative pt-40 pb-32 md:pt-56 md:pb-48 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,var(--accent-wash-top),transparent_70%)] pointer-events-none" />
        
        <div className="_container relative z-10">
          <p
            data-reveal
            className="abt-hero-fade text-xs md:text-sm font-black uppercase tracking-[0.4em] text-accent mb-5 md:mb-8"
          >
            About Wincore
          </p>
          <h1
            data-reveal
            className="abt-hero-title font-heading text-[12vw] md:text-[8vw] lg:text-[7rem] font-black uppercase leading-[0.9] tracking-tighter mb-6 md:mb-8 whitespace-normal sm:whitespace-nowrap overflow-visible"
          >
            boutique standard.{" "}
          ...
          <div
            data-reveal
            className="abt-hero-fade flex flex-col md:flex-row md:items-end justify-between gap-10 border-t border-foreground/10 pt-12 md:pt-16"
          >
            <p className="text-lg md:text-xl font-light text-foreground/60 max-w-3xl leading-relaxed">
            ...
            <div className="flex flex-col gap-3 shrink-0">
              ...
              <span className="text-base md:text-lg font-bold tracking-tight">Colombo · Sri Lanka</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="pt-24 pb-24 md:pt-32 md:pb-48">
        <div className="_container">
          <div
            data-reveal
            className="abt-hero-media relative w-full h-[60vh] md:h-[80vh] rounded-[2.5rem] overflow-hidden bg-black/5"
          >
          <Image
          ...
          <div className="lg:col-span-7 flex flex-col gap-12 md:gap-16 pt-8 lg:pt-0">
            {PHILOSOPHY.map((item, idx) => (
              <div
                key={idx}
                data-reveal
                className="abt-philosophy-row flex gap-6 md:gap-8 items-start group"
              >
            ...
            <div className="flex flex-col gap-16 md:gap-24 relative z-10 w-full">
              {JOURNEY.map((step, idx) => (
                <div
                  key={idx}
                  data-reveal
                  className="abt-journey-step flex gap-8 md:gap-12 items-start relative group"
                >
                  <div className="shrink-0 w-14 h-14 md:w-20 md:h-20 rounded-full bg-background border border-black/10 group-hover:border-accent flex items-center justify-center relative z-10 transition-colors duration-500 shadow-[0_8px_16px_rgba(0,0,0,0.03)] group-hover:shadow-[var(--shadow-accent-journey)]">
        ...
        <div className="_container">
          ...
          >
            <div className="max-w-4xl">
              <p className="text-xs font-black uppercase tracking-[0.5em] text-accent mb-5">
                The Architects
              </p>
              <h2 className="text-[clamp(2.5rem,10vw,6.5rem)] font-black uppercase leading-[0.88] tracking-tighter">
                Meet the Team
              </h2>
            </div>
            <p className="max-w-md text-base md:text-lg text-foreground/50 font-medium leading-relaxed border-l border-accent/20 pl-6 md:pl-8">
          ...
          <div className="abt-team-grid-wrap grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 pb-16 md:pb-24 lg:pb-32">
            {TEAM.map((member, i) => (
              <div key={i} data-reveal className="abt-team-card group relative flex flex-col">
                <div className="abt-team-photoWrap relative aspect-[4/5] w-full overflow-hidden rounded-[2.5rem] bg-foreground/10 shadow-lg shadow-black/5">
                  <Image
                    src={member.image}
                    alt={member.name}
                    fill
                ...
                <div className="abt-team-copy px-2">
                  <h3 className="text-xl font-black tracking-tighter mb-1 transition-colors group-hover:text-accent">{member.name}</h3>
                  <p className="text-xs font-[1000] uppercase tracking-[0.35em] text-accent mb-4">{member.role}</p>
          ...
          <div className="h-8 shrink-0 md:h-12" aria-hidden />
          </div>
        </div>
      </section>
      </div>
      ...
      <section className="py-24 md:py-40 bg-white relative overflow-hidden">
        <div data-reveal className="_container flex flex-col items-center text-center">
